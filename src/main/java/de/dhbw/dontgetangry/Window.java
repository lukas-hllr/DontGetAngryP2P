...
public class Window implements IView {
	...
	private void initialize() {
		...
		for (int i = 0; i < 4; i++) {
			...
			out_fields[0][i].setLocation(window_size-(2-(i%2))*offset_one_field, start_top_left_right_y+offset_one_field*(i<2?0:1));
			...
			out_fields[3][i].setLocation(start_top_left_right_y+offset_one_field*(i%2), start_top_left_right_y+offset_one_field*(i<2?0:1));
